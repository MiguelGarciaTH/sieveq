 ...
 * @author miguel
 */
public class FirstServerFilter implements Runnable {

    private BlockingQueue inQueue, outQueue;
    private ConcurrentHashMap<Integer, ServerSession> sessions;
    private int ID;

    public FirstServerFilter(int ID, BlockingQueue inQueue, BlockingQueue outQueue, ConcurrentHashMap<Integer, ServerSession> sessions) {
        this.ID = ID;
