...
public class Executor implements Runnable {
    ...
    private final RouteTable route;
    private final TreeMap<Integer, Integer> connected;
//    private final ServerViewManager SVM;
    private final ServerViewController SVM;
    ...
    public Executor(ArrayBlockingQueue in, ArrayBlockingQueue out, RouteTable route, TreeMap<Integer, Integer> connected, ServerViewController SVM) {
