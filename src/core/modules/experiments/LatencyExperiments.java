 ...
 * @author miguel
 */
public class LatencyExperiments implements Runnable {
    ...
    public LatencyExperiments(int[] sentSeq, boolean target, Long[] sentTime, BlockingQueue queue, LinkedBlockingQueue in, String results) {
        try {
