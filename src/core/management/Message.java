...
public class Message {
    ...
    /**
     * <| CRYPTO FLAG | DATA TYPE | SRC ID | SEQ NUMB | PAYLOAD SIZE | DATA |> | HMAC or SIGNATURE|
     *
     *
     * @param type
     * @param src
    ...
    //HEADER <[0, 0, 0, 0, 0, 0, 0, 0, 6, 0, 0, 0, 0, 0, 0, 0, 1]>
...
//
    ...
    public static void printHeader(byte[] rawData) {
